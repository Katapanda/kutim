...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Berita List</h5>
                    {{-- button form modal --}}
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            <table id="berita-table" class="table table-stripped">
                                <thead>
                                    <tr>
                                        <th>Judul Berita</th>
                                        <th>ISi Berita</th>
        ...
        {{-- include form modal --}}
        @include('admin.modules.berita.form')
@endsection
...
<script type="text/javascript">
    var oTable = $('#berita-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.api.berita') }}",
                data: function (d) {
                    d.judul_berita = $('input[name=judul_berita]').val();
                    d.isi_berita = $('input[name=isi_berita]').val();
                }
            },
            columns: [
