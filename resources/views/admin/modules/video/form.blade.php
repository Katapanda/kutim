    ...
    <div class="modal-content">
      <form id="form-contact" method="post"  data-toggle="validator" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="md-input-wrapper">
            <input type="text" class="md-form-control md-static" name="keterangan" required placeholder="Keterangan">
            <label>Keterangan</label>
            <span class="help-block with-errors"></span>
          </div>
          <div class="md-input-wrapper">
            <input type="text" class="md-form-control md-static" name="link_video" required placeholder="Link Youtube">
