...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Bidang List</h5>
                    {{-- button form modal --}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form id="search-form" class="form-inline" role="form">
                                ...
                                <div class="form-group">
                                    <input type="text" id="isi_bidang" name="isi_bidang" class="form-control" placeholder="Description">
                                </div>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            <table id="bidang-table" class="table table-stripped">
                                <thead>
                                    <tr>
                                        <th>Judul Bidang</th>
                                        <th>Isi Bidang</th>
        ...
        {{-- include form modal --}}
        @include('admin.modules.bidang.form')
@endsection
...
<script type="text/javascript">
    var oTable = $('#bidang-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.api.bidang') }}",
                data: function (d) {
                    d.judul_bidang = $('input[name=judul]').val();
                    d.isi_bidang = $('input[name=isi_bidang]').val();
                }
            },
            columns: [
                {data: 'judul', name: 'judul'},
                {data: 'isi_bidang', name: 'isi_bidang'},
